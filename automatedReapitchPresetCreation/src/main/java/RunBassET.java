...
//      System.out.println(centDiff(440,428));
      ...
      for (int i = -13; i <= -7; i++) {
         ...
         String presetName = "bass_ET_" + getNoteNameForNegativeOneOctaveShift(i);
      ...
      for (int i = -18; i <= 18; i++) {
         ...
         String presetName = "bass_ET_" + getNoteNameForZeroOctaveShift(i);
      ...
      for (int i = 7; i <= 18; i++) {
         ...
         String presetName = "bass_ET_" + getNoteNameForOneOctaveShift(i);
