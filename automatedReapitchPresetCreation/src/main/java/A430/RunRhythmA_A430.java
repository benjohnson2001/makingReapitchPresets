...
//      System.out.println(centDiff(110,109.6) + centDiff(430,440));
//      System.out.println(centDiff(440,428));

      Pattern currentTrackPattern = new Pattern(RunRhythmA_A430.class.getResource("../currentTrack.png"));
      Pattern closeButtonPattern = new Pattern(RunRhythmA_A430.class.getResource("../closeButton.png"));
      Pattern base1Pattern = new Pattern(RunRhythmA_A430.class.getResource("../base1.png"));
      Pattern shiftCentsPattern = new Pattern(RunRhythmA_A430.class.getResource("../shiftCents.png"));
      Pattern shiftSemitonesPattern = new Pattern(RunRhythmA_A430.class.getResource("../shiftSemitones.png"));
      Pattern shiftOctavesPattern = new Pattern(RunRhythmA_A430.class.getResource("../shiftOctaves.png"));
      Pattern plusButtonPattern = new Pattern(RunRhythmA_A430.class.getResource("../plusButton.png"));

      Pattern okButtonPattern = new Pattern(RunRhythmA_A430.class.getResource("../okButton.png"));
      Pattern exportPatchPattern = new Pattern(RunRhythmA_A430.class.getResource("../exportPatch.png"));
      Pattern savePresetPattern = new Pattern(RunRhythmA_A430.class.getResource("../savePreset.png"));
      Pattern presetNamePattern = new Pattern(RunRhythmA_A430.class.getResource("../presetName.png"));
      Pattern saveAsPattern = new Pattern(RunRhythmA_A430.class.getResource("../saveAs.png"));
      Pattern savePatchButtonPattern = new Pattern(RunRhythmA_A430.class.getResource("../savePatchButton.png"));
      Pattern removeFxPattern = new Pattern(RunRhythmA_A430.class.getResource("../removeFx.png"));
      ...
      for (int i = -9; i <= 18; i++) {
         ...
         screen.type(String.valueOf(centDiff(110,109.6) + centDiff(430,440)));
         ...
         String presetName = "rhythmA_" + getNoteNameForZeroOctaveShift(i) + "_A430";
      ...
      for (int i = 7; i <= 18; i++) {
         ...
         String presetName = "rhythmA_" + getNoteNameForOneOctaveShift(i) + "_A430";
      ...
      for (int i = 7; i <= 18; i++) {
         ...
         String presetName = "rhythmA_" + getNoteNameForTwoOctaveShift(i) + "_A430";
