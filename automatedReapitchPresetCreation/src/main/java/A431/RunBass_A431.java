...
//      System.out.println(centDiff(525.7,523.2));
      System.out.println(centDiff(138.6,138.8) + centDiff(431,440));
//      System.out.println(centDiff(440,428));
      ...
      for (int i = -13; i <= -7; i++) {
         ...
         screen.type(String.valueOf(centDiff(138.6,138.8) + centDiff(431,440)));
         ...
         String presetName = "bass_" + getNoteNameForNegativeOneOctaveShift(i) + "_A431";
      ...
      for (int i = -18; i <= 18; i++) {
         ...
         String presetName = "bass_" + getNoteNameForZeroOctaveShift(i) + "_A431";
      ...
      for (int i = 7; i <= 18; i++) {
         ...
         String presetName = "bass_" + getNoteNameForOneOctaveShift(i) + "_A431";
