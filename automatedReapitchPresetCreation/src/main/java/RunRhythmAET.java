...
//      System.out.println(centDiff(440,428));
      ...
      for (int i = -9; i <= 18; i++) {
         ...
         String presetName = "rhythmA_ET_" + getNoteNameForZeroOctaveShift(i);
      ...
      for (int i = 7; i <= 18; i++) {
         ...
         String presetName = "rhythmA_ET_" + getNoteNameForOneOctaveShift(i);
      ...
      for (int i = 7; i <= 18; i++) {
         ...
         String presetName = "rhythmA_ET_" + getNoteNameForTwoOctaveShift(i);
