...
//      System.out.println(centDiff(110,109.6) + centDiff(429,440));
//      System.out.println(centDiff(440,428));
      ...
      for (int i = -9; i <= 18; i++) {
         ...
         screen.type(String.valueOf(centDiff(110,109.6) + centDiff(429,440)));
         ...
         String presetName = "rhythmA_" + getNoteNameForZeroOctaveShift(i) + "_A429";
      ...
      for (int i = 7; i <= 18; i++) {
         ...
         String presetName = "rhythmA_" + getNoteNameForOneOctaveShift(i) + "_A429";
      ...
      for (int i = 7; i <= 18; i++) {
         ...
         String presetName = "rhythmA_" + getNoteNameForTwoOctaveShift(i) + "_A429";
