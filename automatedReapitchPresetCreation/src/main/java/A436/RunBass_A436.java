...
//      System.out.println(centDiff(525.7,523.2));
      System.out.println(centDiff(138.6,138.8) + centDiff(436,440));
//      System.out.println(centDiff(440,428));

      Pattern currentTrackPattern = new Pattern(RunRhythmA_A436.class.getResource("../currentTrack.png"));
      Pattern closeButtonPattern = new Pattern(RunRhythmA_A436.class.getResource("../closeButton.png"));
      Pattern base1Pattern = new Pattern(RunRhythmA_A436.class.getResource("../base1.png"));
      Pattern shiftCentsPattern = new Pattern(RunRhythmA_A436.class.getResource("../shiftCents.png"));
      Pattern shiftSemitonesPattern = new Pattern(RunRhythmA_A436.class.getResource("../shiftSemitones.png"));
      Pattern shiftOctavesPattern = new Pattern(RunRhythmA_A436.class.getResource("../shiftOctaves.png"));
      Pattern plusButtonPattern = new Pattern(RunRhythmA_A436.class.getResource("../plusButton.png"));

      Pattern okButtonPattern = new Pattern(RunRhythmA_A436.class.getResource("../okButton.png"));
      Pattern exportPatchPattern = new Pattern(RunRhythmA_A436.class.getResource("../exportPatch.png"));
      Pattern savePresetPattern = new Pattern(RunRhythmA_A436.class.getResource("../savePreset.png"));
      Pattern presetNamePattern = new Pattern(RunRhythmA_A436.class.getResource("../presetName.png"));
      Pattern saveAsPattern = new Pattern(RunRhythmA_A436.class.getResource("../saveAs.png"));
      Pattern savePatchButtonPattern = new Pattern(RunRhythmA_A436.class.getResource("../savePatchButton.png"));
      Pattern removeFxPattern = new Pattern(RunRhythmA_A436.class.getResource("../removeFx.png"));
      ...
      for (int i = -13; i <= -7; i++) {
         ...
         screen.type(String.valueOf(centDiff(138.6,138.8) + centDiff(436,440)));
         ...
         String presetName = "bass_" + getNoteNameForNegativeOneOctaveShift(i) + "_A436";
      ...
      for (int i = -18; i <= 18; i++) {
         ...
         String presetName = "bass_" + getNoteNameForZeroOctaveShift(i) + "_A436";
      ...
      for (int i = 7; i <= 18; i++) {
         ...
         String presetName = "bass_" + getNoteNameForOneOctaveShift(i) + "_A436";
