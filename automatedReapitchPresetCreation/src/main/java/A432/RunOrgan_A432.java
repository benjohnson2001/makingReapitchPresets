...
public class RunOrgan_A432 {
   ...
   public static void main(String[] args) throws Exception {
      ...
      for (int i = -18; i <= 18; i++) {
         ...
         screen.type(String.valueOf(centDiff(523.2,525.7) + centDiff(432,440)));
         ...
         String presetName = "organ_" + getNoteNameForZeroOctaveShift(i) + "_A432";
